...
if(NOT "/home/fyin/sim_env/src/pointcloud_to_laserscan/include " STREQUAL " ")
  set(pointcloud_to_laserscan_INCLUDE_DIRS "")
  set(_include_dirs "/home/fyin/sim_env/src/pointcloud_to_laserscan/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'pointcloud_to_laserscan' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/fyin/sim_env/src/pointcloud_to_laserscan/${idir}'.  ${_report}")
    endif()
